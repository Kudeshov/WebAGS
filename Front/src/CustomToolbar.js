...
const OnlineIndicator = () => {
  ...
  return (
    ...
    <div style={{ display: 'flex', alignItems: 'center', color}}>
      {onlineFlightId && <div style={{display: 'flex', alignItems: 'center'}}><HelicopterIcon style={{fill: /* onlineFlightId?"lightgray": */"white", width: 28, height: 28 }} />   
      <span style = {{marginLeft: '10px', fontSize: 'small'}}>{message}</span></div>}
    </div >
    </span>
  );
};
